...
public class ExtentReportManager implements ITestListener
{
	...
	public void onStart(ITestContext testContext) 
	{
		...
		//Title of report
		sparkReporter.config().setDocumentTitle("CAS Automation Report");
		
		//Name of the report
		sparkReporter.config().setReportName("Cognizant Websites Testing");
		
		
		sparkReporter.config().setTheme(Theme.DARK);
		extent = new ExtentReports();
		extent.attachReporter(sparkReporter);
		extent.setSystemInfo("Application", "BeCognizant,Ethics&Compliance");
		extent.setSystemInfo("Module", "CAS Project");
